...
public class ProposalServiceTest {
    ...
    void testCreateProposal() {
        Proposal proposal = new Proposal("Test Proposal", UUID.randomUUID(), "Description", 5, 0, 0);
    ...
    void testCreateProposalWithTitleAlreadyExists() {
        Proposal proposal = new Proposal("Existing Proposal", UUID.randomUUID(), "Description", 5, 0, 0);
    ...
    void testGetResult() {
        ...
        Proposal proposal = new Proposal(title, UUID.randomUUID(), "Description", 5, 2, 1);
